...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header"><?php echo e(session('username')); ?></span>
          <div class="dropdown-divider"></div>
          <!-- <a href="<?php echo e(route('pengelola_edit_password')); ?>" class="dropdown-item">
            Ubah Password
          </a> -->
          <div class="dropdown-divider"></div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">SPORTS <?php echo e(session('level')); ?></span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php if (session('kelola_artikel')): ?>
            <li class="nav-item">
              <a href="<?php echo e(route('pengelola_artikel_list')); ?>" class="nav-link <?= ($halaman=="artikel")?'active':null ?>">
          ...
          <?php if (session('level') == "1"): ?>
            <li class="nav-item">
              <a href="<?php echo e(route('pengelola_akun_list')); ?>" class="nav-link <?= ($halaman=="akun")?'active':null ?>">
...
<?php /**PATH D:\Nikko\Project\portal\resources\views/admin/template.blade.php ENDPATH**/ ?>